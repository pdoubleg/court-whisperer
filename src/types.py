...
class DocMetaData(BaseModel):
    ...
    is_genai: bool = False # was text generated by LLM
    id_: str = ""  # unique id for the document
...
class Document(BaseModel):
    ...
    def id_(self) -> str:
        if (
            hasattr(self.metadata, "id_")
            and self.metadata.id_ is not None
            and self.metadata.id_ != ""
        ):
            return self.metadata.id_
        else:
