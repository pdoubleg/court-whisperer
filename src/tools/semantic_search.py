...
class SemanticSearch:
    ...
    def query_similar_documents(self, text: str, top_n: int, filter_criteria: Optional[dict], use_cosine_similarity: bool = False, similarity_threshold: float = 0.99) -> pd.DataFrame:
